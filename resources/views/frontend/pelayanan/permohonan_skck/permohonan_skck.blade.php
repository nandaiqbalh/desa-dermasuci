        ...
        <div class="row">
            <div class="col-lg-12 ftco-animate">
                <div class="comment-form-wrap pt-5">
                    <h3 class="mb-5">Pengantar Surat Keterangan Catatan Kepolisian</h3>
                    <p>Prosedur pembuatan Pengantar Surat Keterangan Catatan Kepolisian:</p>
                    <ol>
                    ...
                    <form action="{{ route('permohonan-skck.store') }}" method="POST" class="p-5 bg-light">
                        @csrf
