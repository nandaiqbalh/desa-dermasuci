        ...
        <div class="row">
            <div class="col-lg-12 ftco-animate">
                <div class="comment-form-wrap pt-5">
                    <h3 class="mb-5">Surat Pengantar Permohonan KK</h3>
                    <p>Prosedur pembuatan Surat Pengantar Permohonan KK:</p>
                    <ol>
                    ...
                    <form action="{{ route('permohonan-kk.store') }}" method="POST" class="p-5 bg-light">
                        @csrf
