...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT PENGANTAR PERMOHONAN SKCK</u></p>
    ...
    <table class="content">
        ...
        <tr>
            ...
            <td class="content-value">: Surat Pengantar Permohonan Surat Keterangan Catatan Kepolisian</td>
        </tr>
        <tr>
            <td class="content-label">Keterangan Lain</td>
            <td class="content-value">: Benar bahwa nama tersebut diatas adalah warga desa Dermasuci, dan sepengetahuan kami bahwa nama tersebut diatas tergolong warga yang taat hukum dan belum pernah melanggar hukum.</td>
        </tr>
    </table>
