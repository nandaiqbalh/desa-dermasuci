...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT PENGANTAR NIKAH</u></p>
    ...
    <table class="content">
        ...
        <tr>
            <td class="content-label">Nama</td>
            <td class="content-value">: {{$data -> nama_ayah}}</td>
        </tr>
        <tr>
            <td class="content-label">NIK</td>
            <td class="content-value">: {{$data -> nik_ayah}}</td>
        </tr>
        <tr>
            <td class="content-label">Tempat / Tgl Lahir</td>
            <td class="content-value">: {{$data -> tempat_tanggal_lahir_ayah}}</td>
        </tr>
        <tr>
            <td class="content-label">Pekerjaan</td>
            <td class="content-value">: {{$data -> pekerjaan_ayah}}</td>
        </tr>
        <tr>
            <td class="content-label">Alamat</td>
            <td class="content-value">: {{$data -> alamat_ayah}}</td>
        </tr>
        <tr>
            <td class="content-label">Agama</td>
            <td class="content-value">:  {{$data -> agama_ayah}}</td>
        </tr>
        ...
        <tr>
            <td class="content-label">Nama</td>
            <td class="content-value">: {{$data -> nama_ibu}}</td>
        </tr>
        <tr>
            <td class="content-label">NIK</td>
            <td class="content-value">: {{$data -> nik_ibu}}</td>
        </tr>
        <tr>
            <td class="content-label">Tempat / Tgl Lahir</td>
            <td class="content-value">: {{$data -> tempat_tanggal_lahir_ibu}}</td>
        </tr>
        <tr>
            <td class="content-label">Pekerjaan</td>
            <td class="content-value">: {{$data -> pekerjaan_ibu}}</td>
        </tr>
        <tr>
            <td class="content-label">Alamat</td>
            <td class="content-value">: {{$data -> alamat_ibu}}</td>
        </tr>
        <tr>
            <td class="content-label">Agama</td>
            <td class="content-value">:  {{$data -> agama_ibu}}</td>
        </tr>

    </table>

    <p class="content">Demikian Surat Pengantar Nikah ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
