...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT PENGANTAR</u></p>
    ...
    <table class="content">
        ...
        <tr>
            ...
            <td class="content-value">: Surat Pengantar Perubahan Kartu Tanda Penduduk</td>
        </tr>
        <tr>
            <td class="content-label">Keterangan Lain</td>
            <td class="content-value">: Benar bahwa nama tersebut di atas adalah warga desa Dermasuci.</td>
        </tr>
    </table>
