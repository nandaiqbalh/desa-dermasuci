...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT KETERANGAN USAHA</u></p>
    ...
    <p class="content">Sesuai dengan keterangan yang bersangkutan, bahwa memang benar nama tersebut di atas mempunyai usaha sebagai berikut.</p>

    <table class="content">
        <tr>
            <td class="content-label">Nama Usaha</td>
            <td class="content-value">: {{$data -> nama_usaha}}</td>
        </tr>
        <tr>
            <td class="content-label">Tanggal Pendirian</td>
            <td class="content-value">: {{$data -> tanggal_usaha}}</td>
        </tr>
        <tr>
            <td class="content-label">Alamat Usaha</td>
            <td class="content-value">: {{$data -> alamat_usaha}}</td>
        </tr>
        <tr>
            <td class="content-label">Jenis Usaha</td>
            <td class="content-value">: {{$data -> jenis_usaha}}</td>
        </tr>
        <tr>
            <td class="content-label">Keterangan Lain</td>
            <td class="content-value">: Benar bahwa nama tersebut di atas adalah warga desa Dermasuci yang memiliki usaha.</td>
        </tr>
    </table>
    <p class="content">Demikian Surat Keterangan Usaha ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
