...
<body>
    ...
    <p class="content address-line" style="text-align: center; font-size: 12px">Jalan Dukuh Duren No.21 Rt.06 Rw.04 Dermasuci –
        ...
        <p class="content" style="text-align: center; "><u>SURAT PINDAH DOMISILI {{strtoupper($data -> keterangan)}}</u></p>
    ...
    <table class="content">
        ...
        <tr>
            <td class="content-label">Nomor Kartu Keluarga</td>
            <td class="content-value">: {{$data -> no_kk}}</td>
        </tr>
        <tr>
            <td class="content-label">NIK</td>
        ...
        <tr>
            <td class="content-label">Alamat Asal</td>
            <td class="content-value">: {{$data -> alamat_asal}}</td>
        </tr>
        <tr>
            <td class="content-label">Alamat Tujuan</td>
            <td class="content-value">: {{$data -> alamat_tujuan}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content-value">: Surat Pindah Domisili</td>
        </tr>
    </table>

    <p class="content">Demikian Surat Keterangan Pindah Domisili ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
