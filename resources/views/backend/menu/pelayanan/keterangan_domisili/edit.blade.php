...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin_keterangan-domisili.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alamat_ktp" id="alamat_ktp" class="form-control" value="{{ $data->alamat_ktp }}" required>
                </div>

                <div class="form-group">
                    <label for="alamat_sekarang">Alamat Sekarang</label>
                    <input type="text" name="alamat_sekarang" id="alamat_sekarang" class="form-control" value="{{ $data->alamat_sekarang }}" required>
                </div>
