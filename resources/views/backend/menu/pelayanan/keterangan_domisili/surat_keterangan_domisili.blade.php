...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT KETERANGAN DOMISILI</u></p>
    ...
    <table class="content">
        ...
        <tr>
            <td class="content-label">Alamat KTP</td>
            <td class="content-value">: {{$data -> alamat_ktp}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content-value">: Surat Keterangan Domisili</td>
        </tr>
        <tr>
            <td class="content-label">Keterangan Lain</td>
            <td class="content-value">: Benar bahwa nama tersebut di atas adalah warga desa Dermasuci yang saat ini berdomisili di {{$data -> alamat_sekarang}} </td>
        </tr>
    </table>
