...
<body>
    ...
    <p class="content" style="text-align: center; "><u>SURAT PENGANTAR PEMBUATAN AKTA KELAHIRAN</u></p>

    <p class="content" style="text-align: center;">Nomor : {{$data -> no_surat}}</p>

    <p class="content">Yang bertandatangan di bawah ini kepala desa Desa Dermasuci:</p>
    ...
    <table class="content">
        ...
        <tr>
            <td class="content-label">Pekerjaan</td>
            <td class="content-value">: {{$data -> pekerjaan}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content-value">:  {{$data -> agama}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content-value">: Surat Pengantar Pembuatan Akta Kelahiran</td>
        </tr>

    </table>

    <p class="content">Sesuai dengan keterangan yang bersangkutan, bahwa memang benar nama tersebut di atas telah memiliki seorang anak sebagai berikut.</p>

    <table class="content">
        <tr>
            <td class="content-label">Nama Anak</td>
            <td class="content-value">: {{$data -> nama_anak}}</td>
        </tr>
        <tr>
            <td class="content-label">Tempat Tanggal Lahir</td>
            <td class="content-value">: {{$data -> ttl_anak}}</td>
        </tr>
        <tr>
            <td class="content-label">Jenis Kelamin Anak</td>
            <td class="content-value">: {{$data -> jenis_kelamin_anak}}</td>
        </tr>
        <tr>
            <td class="content-label">Keterangan Lain</td>
            <td class="content-value">: {{$data -> keterangan_lain}}</td>
        </tr>

    </table>
    <p class="content">Demikian Surat Pengantar Pembuatan Akta Kelahiran ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
